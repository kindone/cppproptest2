...
TEST(FunctionTraits, basic)
{
    ...
    static_assert(std::is_same_v<TheOtherType, Function<int(int, int)>>, "TheOtherType should be Function<int(int, int)>");
    ...
    static_assert(std::is_same_v<TheOtherType, TheOtherType2>, "TheOtherType and TheOtherType2 should be the same");
    using TheOtherType3 = function_traits<decltype(foo)>::function_type_with_signature<Function>;
    static_assert(std::is_same_v<TheOtherType, TheOtherType3>, "TheOtherType and TheOtherType3 should be the same");

    using TheOtherType4 = function_traits<Bar>::function_type_with_signature<Function>;
    static_assert(std::is_same_v<TheOtherType, TheOtherType4>, "TheOtherType and TheOtherType4 should be the same");
    ...
    static_assert(std::is_same_v<TheOtherType, TheOtherType5>, "TheOtherType and TheOtherType5 should be the same");
}
