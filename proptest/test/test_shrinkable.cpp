...
{
    using Elem = ShrinkableAny::StreamElementType;
    ShrinkableAny shr(Shrinkable<int>(100));
    EXPECT_EQ(shr.getAny().getRef<int>(), 100);
    ShrinkableAny shr2 = shr.with(ShrinkableAny::StreamType::one<Elem>(ShrinkableAny(Shrinkable<int>(200))));
    EXPECT_EQ(shr2.getAny().getRef<int>(), 100);
    EXPECT_EQ(shr2.getShrinks().isEmpty(), false);
    EXPECT_EQ(shr2.getShrinks().getHeadRef<Elem>().getAny().getRef<int>(), 200);
...
TEST(ShrinkableAny, andThenStatic)
{
    ...
    ShrinkableAny shr(util::binarySearchShrinkable(8));
    EXPECT_EQ(shr.getAny().getRef<int64_t>(), 8);
    ShrinkableAny shr2 = shr.andThenStatic(ShrinkableAny::StreamType::one<Elem>(ShrinkableAny(Shrinkable<int64_t>(200))));
    EXPECT_EQ(serializeShrinkableAny<int64_t>(shr), "{value: 8, shrinks: [{value: 0}, {value: 4, shrinks: [{value: 2, shrinks: [{value: 1}]}, {value: 3}]}, {value: 6, shrinks: [{value: 5}]}, {value: 7}]}");
...
TEST(ShrinkableAny, andThen)
{
    ...
    ShrinkableAny shr(util::binarySearchShrinkable(8));
    EXPECT_EQ(shr.getAny().getRef<int64_t>(), 8);
    ShrinkableAny shr2 = shr.andThen([](const Elem& shr) {
        return ShrinkableAny::StreamType::one<Elem>(ShrinkableAny(Shrinkable<int64_t>(100 + shr.getAny().getRef<int64_t>())));
    });
    EXPECT_EQ(serializeShrinkableAny<int64_t>(shr), "{value: 8, shrinks: [{value: 0}, {value: 4, shrinks: [{value: 2, shrinks: [{value: 1}]}, {value: 3}]}, {value: 6, shrinks: [{value: 5}]}, {value: 7}]}");
...
{
    using Shr = ShrinkableAny;
    using Str = Shr::StreamType;
    using Elem = Shr::StreamElementType;

    ShrinkableAny shr(util::binarySearchShrinkable(8));
    EXPECT_EQ(shr.getAny().getRef<int64_t>(), 8);
    ShrinkableAny shr2 = shr.concatStatic(Str::one<Elem>(ShrinkableAny(Shrinkable<int64_t>(200))));
    EXPECT_EQ(serializeShrinkableAny<int64_t>(shr), "{value: 8, shrinks: [{value: 0}, {value: 4, shrinks: [{value: 2, shrinks: [{value: 1}]}, {value: 3}]}, {value: 6, shrinks: [{value: 5}]}, {value: 7}]}");
...
TEST(ShrinkableAny, concat)
{
    ...
    ShrinkableAny shr(util::binarySearchShrinkable(8));
    EXPECT_EQ(shr.getAny().getRef<int64_t>(), 8);
    ShrinkableAny shr2 = shr.concat([](const Elem& shr) {
        return ShrinkableAny::StreamType::one<Elem>(ShrinkableAny(Shrinkable<int64_t>(100 + shr.getAny().getRef<int64_t>())));
    });
    EXPECT_EQ(serializeShrinkableAny<int64_t>(shr), "{value: 8, shrinks: [{value: 0}, {value: 4, shrinks: [{value: 2, shrinks: [{value: 1}]}, {value: 3}]}, {value: 6, shrinks: [{value: 5}]}, {value: 7}]}");
